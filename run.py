...
final_ranking = [i+1 for i in platform.placeOfItems] # places of items in final display
...
if plot:
    ...
    plt.yticks(range(0,num_item),[str(i)+"("+str(int(itm.getQuality()*100)/100)+")" for i,itm in enumerate(platform.items.values())],fontsize=6)
